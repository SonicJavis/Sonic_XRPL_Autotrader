...
Usage:
  ...
  python -m sonic_xrpl.cli.main xaman-governance-response-resolution-register-spec --fixture tests/fixtures/xaman_governance_response_resolution_register_spec/complete_spec_review_ready_resolution_register.json
  python -m sonic_xrpl.cli.main xaman-governance-response-resolution-register-spec-report --fixture tests/fixtures/xaman_governance_response_resolution_register_spec/complete_spec_review_ready_resolution_register.json
  python -m sonic_xrpl.cli.main xaman-governance-resolution-evidence-closure-spec --fixture tests/fixtures/xaman_governance_resolution_evidence_closure_spec/complete_spec_review_ready_closure_bundle.json
  python -m sonic_xrpl.cli.main xaman-governance-resolution-evidence-closure-spec-report --fixture tests/fixtures/xaman_governance_resolution_evidence_closure_spec/complete_spec_review_ready_closure_bundle.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-review-digest-spec --fixture tests/fixtures/xaman_governance_closure_review_digest_spec/complete_spec_review_ready_closure_digest.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-review-digest-spec-report --fixture tests/fixtures/xaman_governance_closure_review_digest_spec/complete_spec_review_ready_closure_digest.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-digest-response-spec --fixture tests/fixtures/xaman_governance_closure_digest_response_spec/complete_spec_review_ready_closure_digest_response_bundle.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-digest-response-spec-report --fixture tests/fixtures/xaman_governance_closure_digest_response_spec/complete_spec_review_ready_closure_digest_response_bundle.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-response-resolution-register-spec --fixture tests/fixtures/xaman_governance_closure_response_resolution_register_spec/complete_spec_review_ready_closure_digest_response_bundle.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-response-resolution-register-spec-report --fixture tests/fixtures/xaman_governance_closure_response_resolution_register_spec/complete_spec_review_ready_closure_digest_response_bundle.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-response-resolution-evidence-pack-spec --fixture tests/fixtures/xaman_governance_closure_response_resolution_evidence_pack_spec/complete_spec_review_ready_evidence_pack.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-response-resolution-evidence-pack-spec-report --fixture tests/fixtures/xaman_governance_closure_response_resolution_evidence_pack_spec/complete_spec_review_ready_evidence_pack.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-response-evidence-pack-review-digest-spec --fixture tests/fixtures/xaman_governance_closure_response_evidence_pack_review_digest_spec/complete_spec_review_ready_evidence_pack_review_digest.json
  python -m sonic_xrpl.cli.main xaman-governance-closure-response-evidence-pack-review-digest-spec-report --fixture tests/fixtures/xaman_governance_closure_response_evidence_pack_review_digest_spec/complete_spec_review_ready_evidence_pack_review_digest.json
...
def main(argv: list[str] | None = None) -> int:
    ...
    xgsrds_parser = subparsers.add_parser("xaman-governance-snapshot-review-digest-spec", help="Run Phase 81 governance snapshot review digest contract spec")
    xgsrds_parser.add_argument("--fixture", required=True, help="Path to xaman governance snapshot review digest fixture JSON")
    xgsrds_parser.add_argument("--json", action="store_true", help="Output as JSON")
    ...
    xgrrrs_parser = subparsers.add_parser("xaman-governance-response-resolution-register-spec", help="Run Phase 83 governance response resolution register contract spec")
    xgrrrs_parser.add_argument("--fixture", required=True, help="Path to xaman governance response resolution register fixture JSON")
    xgrrrs_parser.add_argument("--json", action="store_true", help="Output as JSON")
    xgrrrsr_parser = subparsers.add_parser("xaman-governance-response-resolution-register-spec-report", help="Render Phase 83 governance response resolution register markdown summary")
    xgrrrsr_parser.add_argument("--fixture", required=True, help="Path to xaman governance response resolution register fixture JSON")
    xgrrrsr_parser.add_argument("--output-dir", default="reports/phase83", help="Output directory for report files")
    xgrecs_parser = subparsers.add_parser("xaman-governance-resolution-evidence-closure-spec", help="Run Phase 84 governance resolution evidence closure contract spec")
    xgrecs_parser.add_argument("--fixture", required=True, help="Path to xaman governance resolution evidence closure fixture JSON")
    xgrecs_parser.add_argument("--json", action="store_true", help="Output as JSON")
    xgrecsr_parser = subparsers.add_parser("xaman-governance-resolution-evidence-closure-spec-report", help="Render Phase 84 governance resolution evidence closure markdown summary")
    xgrecsr_parser.add_argument("--fixture", required=True, help="Path to xaman governance resolution evidence closure fixture JSON")
    xgrecsr_parser.add_argument("--output-dir", default="reports/phase84", help="Output directory for report files")
    xgcrds_parser = subparsers.add_parser("xaman-governance-closure-review-digest-spec", help="Run Phase 85 governance closure review digest contract spec")
    xgcrds_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure review digest fixture JSON")
    xgcrds_parser.add_argument("--json", action="store_true", help="Output as JSON")
    xgcrdsr_parser = subparsers.add_parser("xaman-governance-closure-review-digest-spec-report", help="Render Phase 85 governance closure review digest markdown summary")
    xgcrdsr_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure review digest fixture JSON")
    xgcrdsr_parser.add_argument("--output-dir", default="reports/phase85", help="Output directory for report files")
    xgcdrs_parser = subparsers.add_parser("xaman-governance-closure-digest-response-spec", help="Run Phase 86 governance closure digest response contract spec")
    xgcdrs_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure digest response fixture JSON")
    xgcdrs_parser.add_argument("--json", action="store_true", help="Output as JSON")
    xgcdrsr_parser = subparsers.add_parser("xaman-governance-closure-digest-response-spec-report", help="Render Phase 86 governance closure digest response markdown summary")
    xgcdrsr_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure digest response fixture JSON")
    xgcdrsr_parser.add_argument("--output-dir", default="reports/phase86", help="Output directory for report files")
    xgcrrrs_parser = subparsers.add_parser("xaman-governance-closure-response-resolution-register-spec", help="Run Phase 87 governance closure response resolution register contract spec")
    xgcrrrs_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure response resolution register fixture JSON")
    xgcrrrs_parser.add_argument("--json", action="store_true", help="Output as JSON")
    xgcrrrsr_parser = subparsers.add_parser("xaman-governance-closure-response-resolution-register-spec-report", help="Render Phase 87 governance closure response resolution register markdown summary")
    xgcrrrsr_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure response resolution register fixture JSON")
    xgcrrrsr_parser.add_argument("--output-dir", default="reports/phase87", help="Output directory for report files")
    xgcrreps_parser = subparsers.add_parser("xaman-governance-closure-response-resolution-evidence-pack-spec", help="Run Phase 88 governance closure response resolution evidence pack contract spec")
    xgcrreps_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure response resolution evidence pack fixture JSON")
    xgcrreps_parser.add_argument("--json", action="store_true", help="Output as JSON")
    xgcrrepsr_parser = subparsers.add_parser("xaman-governance-closure-response-resolution-evidence-pack-spec-report", help="Render Phase 88 governance closure response resolution evidence pack markdown summary")
    xgcrrepsr_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure response resolution evidence pack fixture JSON")
    xgcrrepsr_parser.add_argument("--output-dir", default="reports/phase88", help="Output directory for report files")
    xgcrepds_parser = subparsers.add_parser("xaman-governance-closure-response-evidence-pack-review-digest-spec", help="Run Phase 89 governance closure response evidence pack review digest contract spec")
    xgcrepds_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure response evidence pack review digest fixture JSON")
    xgcrepds_parser.add_argument("--json", action="store_true", help="Output as JSON")
    xgcrepdsr_parser = subparsers.add_parser("xaman-governance-closure-response-evidence-pack-review-digest-spec-report", help="Render Phase 89 governance closure response evidence pack review digest markdown summary")
    xgcrepdsr_parser.add_argument("--fixture", required=True, help="Path to xaman governance closure response evidence pack review digest fixture JSON")
    xgcrepdsr_parser.add_argument("--output-dir", default="reports/phase89", help="Output directory for report files")
    ...
    if args.command == "xaman-governance-snapshot-review-digest-spec":
    ...
    if args.command == "xaman-governance-response-resolution-register-spec":
        return _cmd_xaman_governance_response_resolution_register_spec(args)
    if args.command == "xaman-governance-response-resolution-register-spec-report":
        return _cmd_xaman_governance_response_resolution_register_spec_report(args)
    if args.command == "xaman-governance-resolution-evidence-closure-spec":
        return _cmd_xaman_governance_resolution_evidence_closure_spec(args)
    if args.command == "xaman-governance-resolution-evidence-closure-spec-report":
        return _cmd_xaman_governance_resolution_evidence_closure_spec_report(args)
    if args.command == "xaman-governance-closure-review-digest-spec":
        return _cmd_xaman_governance_closure_review_digest_spec(args)
    if args.command == "xaman-governance-closure-review-digest-spec-report":
        return _cmd_xaman_governance_closure_review_digest_spec_report(args)
    if args.command == "xaman-governance-closure-digest-response-spec":
        return _cmd_xaman_governance_closure_digest_response_spec(args)
    if args.command == "xaman-governance-closure-digest-response-spec-report":
        return _cmd_xaman_governance_closure_digest_response_spec_report(args)
    if args.command == "xaman-governance-closure-response-resolution-register-spec":
        return _cmd_xaman_governance_closure_response_resolution_register_spec(args)
    if args.command == "xaman-governance-closure-response-resolution-register-spec-report":
        return _cmd_xaman_governance_closure_response_resolution_register_spec_report(args)
    if args.command == "xaman-governance-closure-response-resolution-evidence-pack-spec":
        return _cmd_xaman_governance_closure_response_resolution_evidence_pack_spec(args)
    if args.command == "xaman-governance-closure-response-resolution-evidence-pack-spec-report":
        return _cmd_xaman_governance_closure_response_resolution_evidence_pack_spec_report(args)
    if args.command == "xaman-governance-closure-response-evidence-pack-review-digest-spec":
        return _cmd_xaman_governance_closure_response_evidence_pack_review_digest_spec(args)
    if args.command == "xaman-governance-closure-response-evidence-pack-review-digest-spec-report":
        return _cmd_xaman_governance_closure_response_evidence_pack_review_digest_spec_report(args)
...
def _cmd_xaman_governance_snapshot_review_digest_spec(args):
    from sonic_xrpl.xaman_governance_snapshot_review_digest_spec import build_xaman_governance_snapshot_review_digest_spec, load_xaman_governance_snapshot_review_digest_fixture, render_xaman_governance_snapshot_review_digest_json, render_xaman_governance_snapshot_review_digest_markdown
    ...
    print(render_xaman_governance_snapshot_review_digest_json(report) if args.json else render_xaman_governance_snapshot_review_digest_markdown(report))
    return 0

def _cmd_xaman_governance_snapshot_review_digest_spec_report(args):
    from sonic_xrpl.xaman_governance_snapshot_review_digest_spec import build_xaman_governance_snapshot_review_digest_spec, load_xaman_governance_snapshot_review_digest_fixture, render_xaman_governance_snapshot_review_digest_markdown, write_xaman_governance_snapshot_review_digest_reports
    report = build_xaman_governance_snapshot_review_digest_spec(load_xaman_governance_snapshot_review_digest_fixture(args.fixture))
...
def _cmd_xaman_governance_response_resolution_register_spec(args):
    from sonic_xrpl.xaman_governance_response_resolution_register_spec import build_xaman_governance_response_resolution_register_spec, load_xaman_governance_response_resolution_register_fixture, render_xaman_governance_response_resolution_register_json, render_xaman_governance_response_resolution_register_markdown
    report = build_xaman_governance_response_resolution_register_spec(load_xaman_governance_response_resolution_register_fixture(args.fixture))
    print(render_xaman_governance_response_resolution_register_json(report) if args.json else render_xaman_governance_response_resolution_register_markdown(report))
    return 0

def _cmd_xaman_governance_response_resolution_register_spec_report(args):
    from sonic_xrpl.xaman_governance_response_resolution_register_spec import build_xaman_governance_response_resolution_register_spec, load_xaman_governance_response_resolution_register_fixture, render_xaman_governance_response_resolution_register_markdown, write_xaman_governance_response_resolution_register_reports
    report = build_xaman_governance_response_resolution_register_spec(load_xaman_governance_response_resolution_register_fixture(args.fixture))
    print(render_xaman_governance_response_resolution_register_markdown(report))
    json_path, md_path = write_xaman_governance_response_resolution_register_reports(report, args.output_dir)
    print(f"\nWrote: {json_path}")
    print(f"Wrote: {md_path}")
    return 0

def _cmd_xaman_governance_resolution_evidence_closure_spec(args):
    from sonic_xrpl.xaman_governance_resolution_evidence_closure_spec import build_xaman_governance_resolution_evidence_closure_spec, load_xaman_governance_resolution_evidence_closure_fixture, render_xaman_governance_resolution_evidence_closure_json, render_xaman_governance_resolution_evidence_closure_markdown
    report = build_xaman_governance_resolution_evidence_closure_spec(load_xaman_governance_resolution_evidence_closure_fixture(args.fixture))
    print(render_xaman_governance_resolution_evidence_closure_json(report) if args.json else render_xaman_governance_resolution_evidence_closure_markdown(report))
    return 0

def _cmd_xaman_governance_resolution_evidence_closure_spec_report(args):
    from sonic_xrpl.xaman_governance_resolution_evidence_closure_spec import build_xaman_governance_resolution_evidence_closure_spec, load_xaman_governance_resolution_evidence_closure_fixture, render_xaman_governance_resolution_evidence_closure_markdown, write_xaman_governance_resolution_evidence_closure_reports
    report = build_xaman_governance_resolution_evidence_closure_spec(load_xaman_governance_resolution_evidence_closure_fixture(args.fixture))
    print(render_xaman_governance_resolution_evidence_closure_markdown(report))
    json_path, md_path = write_xaman_governance_resolution_evidence_closure_reports(report, args.output_dir)
    print(f"\nWrote: {json_path}")
    print(f"Wrote: {md_path}")
    return 0

def _cmd_xaman_governance_closure_review_digest_spec(args):
    from sonic_xrpl.xaman_governance_closure_review_digest_spec import build_xaman_governance_closure_review_digest_spec, load_xaman_governance_closure_review_digest_fixture, render_xaman_governance_closure_review_digest_json, render_xaman_governance_closure_review_digest_markdown
    report = build_xaman_governance_closure_review_digest_spec(load_xaman_governance_closure_review_digest_fixture(args.fixture))
    print(render_xaman_governance_closure_review_digest_json(report) if args.json else render_xaman_governance_closure_review_digest_markdown(report))
    return 0

def _cmd_xaman_governance_closure_review_digest_spec_report(args):
    from sonic_xrpl.xaman_governance_closure_review_digest_spec import build_xaman_governance_closure_review_digest_spec, load_xaman_governance_closure_review_digest_fixture, render_xaman_governance_closure_review_digest_markdown, write_xaman_governance_closure_review_digest_reports
    report = build_xaman_governance_closure_review_digest_spec(load_xaman_governance_closure_review_digest_fixture(args.fixture))
    print(render_xaman_governance_closure_review_digest_markdown(report))
    json_path, md_path = write_xaman_governance_closure_review_digest_reports(report, args.output_dir)
    print(f"\nWrote: {json_path}")
    print(f"Wrote: {md_path}")
    return 0

def _cmd_xaman_governance_closure_digest_response_spec(args):
    from sonic_xrpl.xaman_governance_closure_digest_response_spec import build_xaman_governance_closure_digest_response_spec, load_xaman_governance_closure_digest_response_fixture, render_xaman_governance_closure_digest_response_json, render_xaman_governance_closure_digest_response_markdown
    report = build_xaman_governance_closure_digest_response_spec(load_xaman_governance_closure_digest_response_fixture(args.fixture))
    print(render_xaman_governance_closure_digest_response_json(report) if args.json else render_xaman_governance_closure_digest_response_markdown(report))
    return 0

def _cmd_xaman_governance_closure_digest_response_spec_report(args):
    from sonic_xrpl.xaman_governance_closure_digest_response_spec import build_xaman_governance_closure_digest_response_spec, load_xaman_governance_closure_digest_response_fixture, render_xaman_governance_closure_digest_response_markdown, write_xaman_governance_closure_digest_response_reports
    report = build_xaman_governance_closure_digest_response_spec(load_xaman_governance_closure_digest_response_fixture(args.fixture))
    print(render_xaman_governance_closure_digest_response_markdown(report))
    json_path, md_path = write_xaman_governance_closure_digest_response_reports(report, args.output_dir)
    print(f"\nWrote: {json_path}")
    print(f"Wrote: {md_path}")
    return 0

def _cmd_xaman_governance_closure_response_resolution_register_spec(args):
    from sonic_xrpl.xaman_governance_closure_response_resolution_register_spec import build_xaman_governance_closure_response_resolution_register_spec, load_xaman_governance_closure_response_resolution_register_fixture, render_xaman_governance_closure_response_resolution_register_json, render_xaman_governance_closure_response_resolution_register_markdown
    report = build_xaman_governance_closure_response_resolution_register_spec(load_xaman_governance_closure_response_resolution_register_fixture(args.fixture))
    print(render_xaman_governance_closure_response_resolution_register_json(report) if args.json else render_xaman_governance_closure_response_resolution_register_markdown(report))
    return 0

def _cmd_xaman_governance_closure_response_resolution_register_spec_report(args):
    from sonic_xrpl.xaman_governance_closure_response_resolution_register_spec import build_xaman_governance_closure_response_resolution_register_spec, load_xaman_governance_closure_response_resolution_register_fixture, render_xaman_governance_closure_response_resolution_register_markdown, write_xaman_governance_closure_response_resolution_register_reports
    report = build_xaman_governance_closure_response_resolution_register_spec(load_xaman_governance_closure_response_resolution_register_fixture(args.fixture))
    print(render_xaman_governance_closure_response_resolution_register_markdown(report))
    json_path, md_path = write_xaman_governance_closure_response_resolution_register_reports(report, args.output_dir)
    print(f"\nWrote: {json_path}")
    print(f"Wrote: {md_path}")
    return 0

def _cmd_xaman_governance_closure_response_resolution_evidence_pack_spec(args):
    from sonic_xrpl.xaman_governance_closure_response_resolution_evidence_pack_spec import build_xaman_governance_closure_response_resolution_evidence_pack_spec, load_xaman_governance_closure_response_resolution_evidence_pack_fixture, render_xaman_governance_closure_response_resolution_evidence_pack_json, render_xaman_governance_closure_response_resolution_evidence_pack_markdown
    report = build_xaman_governance_closure_response_resolution_evidence_pack_spec(load_xaman_governance_closure_response_resolution_evidence_pack_fixture(args.fixture))
    print(render_xaman_governance_closure_response_resolution_evidence_pack_json(report) if args.json else render_xaman_governance_closure_response_resolution_evidence_pack_markdown(report))
    return 0

def _cmd_xaman_governance_closure_response_resolution_evidence_pack_spec_report(args):
    from sonic_xrpl.xaman_governance_closure_response_resolution_evidence_pack_spec import build_xaman_governance_closure_response_resolution_evidence_pack_spec, load_xaman_governance_closure_response_resolution_evidence_pack_fixture, render_xaman_governance_closure_response_resolution_evidence_pack_markdown, write_xaman_governance_closure_response_resolution_evidence_pack_reports
    report = build_xaman_governance_closure_response_resolution_evidence_pack_spec(load_xaman_governance_closure_response_resolution_evidence_pack_fixture(args.fixture))
    print(render_xaman_governance_closure_response_resolution_evidence_pack_markdown(report))
    json_path, md_path = write_xaman_governance_closure_response_resolution_evidence_pack_reports(report, args.output_dir)
    print(f"\nWrote: {json_path}")
    print(f"Wrote: {md_path}")
    return 0

def _cmd_xaman_governance_closure_response_evidence_pack_review_digest_spec(args):
    from sonic_xrpl.xaman_governance_closure_response_evidence_pack_review_digest_spec import build_xaman_governance_closure_response_evidence_pack_review_digest_spec, load_xaman_governance_closure_response_evidence_pack_review_digest_fixture, render_xaman_governance_closure_response_evidence_pack_review_digest_json, render_xaman_governance_closure_response_evidence_pack_review_digest_markdown
    report = build_xaman_governance_closure_response_evidence_pack_review_digest_spec(load_xaman_governance_closure_response_evidence_pack_review_digest_fixture(args.fixture))
    print(render_xaman_governance_closure_response_evidence_pack_review_digest_json(report) if args.json else render_xaman_governance_closure_response_evidence_pack_review_digest_markdown(report))
    return 0

def _cmd_xaman_governance_closure_response_evidence_pack_review_digest_spec_report(args):
    from sonic_xrpl.xaman_governance_closure_response_evidence_pack_review_digest_spec import build_xaman_governance_closure_response_evidence_pack_review_digest_spec, load_xaman_governance_closure_response_evidence_pack_review_digest_fixture, render_xaman_governance_closure_response_evidence_pack_review_digest_markdown, write_xaman_governance_closure_response_evidence_pack_review_digest_reports
    report = build_xaman_governance_closure_response_evidence_pack_review_digest_spec(load_xaman_governance_closure_response_evidence_pack_review_digest_fixture(args.fixture))
    print(render_xaman_governance_closure_response_evidence_pack_review_digest_markdown(report))
    json_path, md_path = write_xaman_governance_closure_response_evidence_pack_review_digest_reports(report, args.output_dir)
    print(f"\nWrote: {json_path}")
    print(f"Wrote: {md_path}")
    return 0
