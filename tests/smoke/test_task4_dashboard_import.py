...
def test_task4_dashboard_imports_without_side_effect() -> None:
    ...
    import dashboard.views.production_dashboard as production
    import dashboard.views.safety_status as safety
    import dashboard.views.governance_status as governance
